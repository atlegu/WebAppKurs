  ...
  sections: [
    ...
    // ===================================
    {
      ...
      content: [
        ...
        {
          id: '3-2-diagram-tidslinje',
          type: 'diagram',
          order: 15.5,
          title: 'Obligasjonens kontantstrømmer over tid',
          svg: `<svg viewBox="0 0 640 300" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Obligasjonens kontantstrømmer over tid"><line x1="40" y1="155" x2="600" y2="155" stroke="#374151" stroke-width="2"/><line x1="70" y1="155" x2="70" y2="210" stroke="#ef4444" stroke-width="3"/><polygon points="70,219 64,207 76,207" fill="#ef4444"/><text x="70.0" y="226.0" font-family="Inter, system-ui, sans-serif" font-size="11" font-weight="700" fill="#ef4444" text-anchor="middle">−1000</text><text x="70.0" y="147.0" font-family="Inter, system-ui, sans-serif" font-size="12" font-weight="400" fill="currentColor" text-anchor="middle"></text><text x="70.0" y="286.0" font-family="Inter, system-ui, sans-serif" font-size="11" font-weight="400" fill="currentColor" text-anchor="middle">År 0</text><line x1="165" y1="155" x2="165" y2="115" stroke="#10b981" stroke-width="3"/><polygon points="165,106 159,118 171,118" fill="#10b981"/><text x="165.0" y="109.0" font-family="Inter, system-ui, sans-serif" font-size="11" font-weight="700" fill="#10b981" text-anchor="middle">+60</text><text x="165.0" y="173.0" font-family="Inter, system-ui, sans-serif" font-size="12" font-weight="400" fill="currentColor" text-anchor="middle"></text><text x="165.0" y="286.0" font-family="Inter, system-ui, sans-serif" font-size="11" font-weight="400" fill="currentColor" text-anchor="middle">År 1</text><line x1="260" y1="155" x2="260" y2="115" stroke="#10b981" stroke-width="3"/><polygon points="260,106 254,118 266,118" fill="#10b981"/><text x="260.0" y="109.0" font-family="Inter, system-ui, sans-serif" font-size="11" font-weight="700" fill="#10b981" text-anchor="middle">+60</text><text x="260.0" y="173.0" font-family="Inter, system-ui, sans-serif" font-size="12" font-weight="400" fill="currentColor" text-anchor="middle"></text><text x="260.0" y="286.0" font-family="Inter, system-ui, sans-serif" font-size="11" font-weight="400" fill="currentColor" text-anchor="middle">År 2</text><line x1="355" y1="155" x2="355" y2="115" stroke="#10b981" stroke-width="3"/><polygon points="355,106 349,118 361,118" fill="#10b981"/><text x="355.0" y="109.0" font-family="Inter, system-ui, sans-serif" font-size="11" font-weight="700" fill="#10b981" text-anchor="middle">+60</text><text x="355.0" y="173.0" font-family="Inter, system-ui, sans-serif" font-size="12" font-weight="400" fill="currentColor" text-anchor="middle"></text><text x="355.0" y="286.0" font-family="Inter, system-ui, sans-serif" font-size="11" font-weight="400" fill="currentColor" text-anchor="middle">År 3</text><line x1="450" y1="155" x2="450" y2="115" stroke="#10b981" stroke-width="3"/><polygon points="450,106 444,118 456,118" fill="#10b981"/><text x="450.0" y="109.0" font-family="Inter, system-ui, sans-serif" font-size="11" font-weight="700" fill="#10b981" text-anchor="middle">+60</text><text x="450.0" y="173.0" font-family="Inter, system-ui, sans-serif" font-size="12" font-weight="400" fill="currentColor" text-anchor="middle"></text><text x="450.0" y="286.0" font-family="Inter, system-ui, sans-serif" font-size="11" font-weight="400" fill="currentColor" text-anchor="middle">År 4</text><line x1="545" y1="155" x2="545" y2="75" stroke="#046530" stroke-width="3"/><polygon points="545,66 539,78 551,78" fill="#046530"/><text x="545.0" y="69.0" font-family="Inter, system-ui, sans-serif" font-size="11" font-weight="700" fill="#046530" text-anchor="middle">+1060</text><text x="545.0" y="173.0" font-family="Inter, system-ui, sans-serif" font-size="12" font-weight="400" fill="currentColor" text-anchor="middle"></text><text x="545.0" y="286.0" font-family="Inter, system-ui, sans-serif" font-size="11" font-weight="400" fill="currentColor" text-anchor="middle">År 5</text><text x="320.0" y="28.0" font-family="Inter, system-ui, sans-serif" font-size="11" font-weight="400" fill="#6b7280" text-anchor="middle">Du betaler i dag, mottar kuponger årlig, og får pålydende + siste kupong ved forfall</text></svg>`,
          caption: 'Samme obligasjon som i regneeksempelet under: pålydende 1 000 kr, 6 % kupong gir 60 kr årlig. Ved forfall (år 5) får du siste kupong pluss pålydende = 1 060 kr. Den røde pilen ned er kjøpsprisen du betaler i dag; de grønne pilene opp er det du mottar.'
        },
        {
    ...
    // ===================================
    {
      ...
      content: [
        ...
        {
          id: '3-5-diagram-balansebjelke',
          type: 'diagram',
          order: 4.5,
          title: 'Durasjon som balansepunkt',
          svg: `<svg viewBox="0 0 640 320" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Durasjon som balansepunkt"><rect x="90" y="124" width="470" height="12" fill="#046530" rx="3"/><line x1="150" y1="136" x2="150" y2="160" stroke="#9ca3af" stroke-width="1.5"/><circle cx="150" cy="170.10257348427749" r="10.1" fill="#10b981" opacity="0.85"/><text x="150.0" y="156.0" font-family="Inter, system-ui, sans-serif" font-size="12" font-weight="400" fill="currentColor" text-anchor="middle"></text><text x="150.0" y="116.0" font-family="Inter, system-ui, sans-serif" font-size="10" font-weight="400" fill="currentColor" text-anchor="middle">År 1</text><text x="150.0" y="174.1" font-family="Inter, system-ui, sans-serif" font-size="9" font-weight="400" fill="#374151" text-anchor="middle">PV 48</text><line x1="240" y1="136" x2="240" y2="160" stroke="#9ca3af" stroke-width="1.5"/><circle cx="240" cy="169.8663488768869" r="9.9" fill="#10b981" opacity="0.85"/><text x="240.0" y="156.0" font-family="Inter, system-ui, sans-serif" font-size="12" font-weight="400" fill="currentColor" text-anchor="middle"></text><text x="240.0" y="116.0" font-family="Inter, system-ui, sans-serif" font-size="10" font-weight="400" fill="currentColor" text-anchor="middle">År 2</text><text x="240.0" y="173.9" font-family="Inter, system-ui, sans-serif" font-size="9" font-weight="400" fill="#374151" text-anchor="middle">PV 45</text><line x1="330" y1="136" x2="330" y2="160" stroke="#9ca3af" stroke-width="1.5"/><circle cx="330" cy="169.62432799293893" r="9.6" fill="#10b981" opacity="0.85"/><text x="330.0" y="156.0" font-family="Inter, system-ui, sans-serif" font-size="12" font-weight="400" fill="currentColor" text-anchor="middle"></text><text x="330.0" y="116.0" font-family="Inter, system-ui, sans-serif" font-size="10" font-weight="400" fill="currentColor" text-anchor="middle">År 3</text><text x="330.0" y="173.6" font-family="Inter, system-ui, sans-serif" font-size="9" font-weight="400" fill="#374151" text-anchor="middle">PV 43</text><line x1="420" y1="136" x2="420" y2="160" stroke="#9ca3af" stroke-width="1.5"/><circle cx="420" cy="169.38748924997407" r="9.4" fill="#10b981" opacity="0.85"/><text x="420.0" y="156.0" font-family="Inter, system-ui, sans-serif" font-size="12" font-weight="400" fill="currentColor" text-anchor="middle"></text><text x="420.0" y="116.0" font-family="Inter, system-ui, sans-serif" font-size="10" font-weight="400" fill="currentColor" text-anchor="middle">År 4</text><text x="420.0" y="173.4" font-family="Inter, system-ui, sans-serif" font-size="9" font-weight="400" fill="#374151" text-anchor="middle">PV 41</text><line x1="520" y1="136" x2="520" y2="160" stroke="#9ca3af" stroke-width="1.5"/><circle cx="520" cy="202" r="42.0" fill="#10b981" opacity="0.85"/><text x="520.0" y="206.0" font-family="Inter, system-ui, sans-serif" font-size="12" font-weight="400" fill="currentColor" text-anchor="middle"></text><text x="520.0" y="116.0" font-family="Inter, system-ui, sans-serif" font-size="10" font-weight="400" fill="currentColor" text-anchor="middle">År 5</text><text x="520.0" y="206.0" font-family="Inter, system-ui, sans-serif" font-size="11" font-weight="400" fill="#fff" text-anchor="middle">PV 823</text><polygon points="478.375,136 462.375,170 494.375,170" fill="#f59e0b"/><text x="478.4" y="192.0" font-family="Inter, system-ui, sans-serif" font-size="12" font-weight="700" fill="#b45309" text-anchor="middle">Durasjon ≈ 4,55 år</text><text x="320.0" y="26.0" font-family="Inter, system-ui, sans-serif" font-size="11" font-weight="400" fill="#6b7280" text-anchor="middle">Balansepunktet (durasjonen) trekkes mot år 5 – der ligger mesteparten av nåverdien</text></svg>`,
          caption: 'Tenk på durasjonen som balansepunktet på en vektstang. Hver kontantstrøm er et lodd med vekt lik nåverdien (PV), plassert i sitt utbetalingsår. Fordi hele pålydende betales i år 5, veier det året tyngst – og balansepunktet (durasjonen) trekkes tett opp mot forfall. En nullkupongobligasjon ville hatt durasjon lik løpetiden; kuponger trekker den ned.'
        },
        {
    ...
    // ===================================
    {
      ...
      content: [
        ...
        {
          id: '3-7-diagram-spread',
          type: 'diagram',
          order: 12.5,
          title: 'Kredittspread etter rating',
          svg: `<svg viewBox="0 0 640 320" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Kredittspread etter rating"><line x1="20" y1="250" x2="620" y2="250" stroke="#374151" stroke-width="1.5"/><rect x="47.8" y="190.0" width="54.0" height="60.0" fill="#3b82f6" rx="2"/><rect x="47.8" y="185.5" width="54.0" height="4.5" fill="#f59e0b" rx="2"/><text x="74.8" y="179.5" font-family="Inter, system-ui, sans-serif" font-size="10" font-weight="700" fill="currentColor" text-anchor="middle">4.3%</text><text x="74.8" y="266.0" font-family="Inter, system-ui, sans-serif" font-size="11" font-weight="700" fill="currentColor" text-anchor="middle">AAA</text><rect x="129.5" y="190.0" width="54.0" height="60.0" fill="#3b82f6" rx="2"/><rect x="129.5" y="182.5" width="54.0" height="7.5" fill="#f59e0b" rx="2"/><text x="156.5" y="176.5" font-family="Inter, system-ui, sans-serif" font-size="10" font-weight="700" fill="currentColor" text-anchor="middle">4.5%</text><text x="156.5" y="266.0" font-family="Inter, system-ui, sans-serif" font-size="11" font-weight="700" fill="currentColor" text-anchor="middle">AA</text><rect x="211.3" y="190.0" width="54.0" height="60.0" fill="#3b82f6" rx="2"/><rect x="211.3" y="178.0" width="54.0" height="12.0" fill="#f59e0b" rx="2"/><text x="238.3" y="172.0" font-family="Inter, system-ui, sans-serif" font-size="10" font-weight="700" fill="currentColor" text-anchor="middle">4.8%</text><text x="238.3" y="266.0" font-family="Inter, system-ui, sans-serif" font-size="11" font-weight="700" fill="currentColor" text-anchor="middle">A</text><rect x="293.0" y="190.0" width="54.0" height="60.0" fill="#3b82f6" rx="2"/><rect x="293.0" y="167.5" width="54.0" height="22.5" fill="#f59e0b" rx="2"/><text x="320.0" y="161.5" font-family="Inter, system-ui, sans-serif" font-size="10" font-weight="700" fill="currentColor" text-anchor="middle">5.5%</text><text x="320.0" y="266.0" font-family="Inter, system-ui, sans-serif" font-size="11" font-weight="700" fill="currentColor" text-anchor="middle">BBB</text><rect x="374.8" y="190.0" width="54.0" height="60.0" fill="#3b82f6" rx="2"/><rect x="374.8" y="145.0" width="54.0" height="45.0" fill="#f59e0b" rx="2"/><text x="401.8" y="139.0" font-family="Inter, system-ui, sans-serif" font-size="10" font-weight="700" fill="currentColor" text-anchor="middle">7.0%</text><text x="401.8" y="266.0" font-family="Inter, system-ui, sans-serif" font-size="11" font-weight="700" fill="currentColor" text-anchor="middle">BB</text><rect x="456.5" y="190.0" width="54.0" height="60.0" fill="#3b82f6" rx="2"/><rect x="456.5" y="115.0" width="54.0" height="75.0" fill="#f59e0b" rx="2"/><text x="483.5" y="109.0" font-family="Inter, system-ui, sans-serif" font-size="10" font-weight="700" fill="currentColor" text-anchor="middle">9.0%</text><text x="483.5" y="266.0" font-family="Inter, system-ui, sans-serif" font-size="11" font-weight="700" fill="currentColor" text-anchor="middle">B</text><rect x="538.3" y="190.0" width="54.0" height="60.0" fill="#3b82f6" rx="2"/><rect x="538.3" y="40.0" width="54.0" height="150.0" fill="#f59e0b" rx="2"/><text x="565.3" y="34.0" font-family="Inter, system-ui, sans-serif" font-size="10" font-weight="700" fill="currentColor" text-anchor="middle">14.0%</text><text x="565.3" y="266.0" font-family="Inter, system-ui, sans-serif" font-size="11" font-weight="700" fill="currentColor" text-anchor="middle">CCC</text><line x1="360.875" y1="30" x2="360.875" y2="250" stroke="#6b7280" stroke-width="1.5" stroke-dasharray="5,4"/><text x="290.9" y="44.0" font-family="Inter, system-ui, sans-serif" font-size="10" font-weight="400" fill="#6b7280" text-anchor="middle">Investment grade</text><text x="430.9" y="44.0" font-family="Inter, system-ui, sans-serif" font-size="10" font-weight="400" fill="#6b7280" text-anchor="middle">High yield («junk»)</text><rect x="40.0" y="298.0" width="12.0" height="12.0" fill="#3b82f6" rx="2"/><text x="58.0" y="308.0" font-family="Inter, system-ui, sans-serif" font-size="10" font-weight="400" fill="currentColor" text-anchor="start">Risikofri rente (4%)</text><rect x="220.0" y="298.0" width="12.0" height="12.0" fill="#f59e0b" rx="2"/><text x="238.0" y="308.0" font-family="Inter, system-ui, sans-serif" font-size="10" font-weight="400" fill="currentColor" text-anchor="start">Kredittpåslag (spread)</text></svg>`,
          caption: 'De samme tallene som i tabellen over, visualisert. Den blå sokkelen er den risikofrie renten (4 %) som alle betaler; det gule påslaget er kredittspreaden, som vokser dramatisk nedover ratingskalaen. Den stiplede linjen skiller Investment Grade (BBB– og bedre) fra High Yield. Legg merke til hoppet fra BBB til BB – det er her mange fond må selge.'
        },
        {
