  ...
  sections: [
    ...
    // SEKSJON 2.2: Resultatregnskapet
    {
      ...
      content: [
        ...
        {
          id: '2-2-diagram-resultat',
          type: 'diagram',
          order: 4.5,
          title: 'Fra inntekt til bunnlinje – hvor blir pengene av?',
          svg: `<svg viewBox="0 0 640 360" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Resultatregnskap som waterfall"><line x1="20" y1="300" x2="630" y2="300" stroke="#d1d5db" stroke-width="1"/><rect x="30.0" y="60.0" width="72.0" height="240.0" fill="#046530" rx="2"/><line x1="30" y1="60.0" x2="202" y2="60.0" stroke="#9ca3af" stroke-width="1" stroke-dasharray="3,3"/><text x="66.0" y="55.0" font-family="Inter, system-ui, sans-serif" font-size="11" font-weight="700" fill="#046530" text-anchor="middle">1000</text><text x="66.0" y="318.0" font-family="Inter, system-ui, sans-serif" font-size="9.5" font-weight="400" fill="currentColor" text-anchor="middle">Driftsinntekter</text><rect x="130.0" y="60.0" width="72.0" height="96.0" fill="#f59e0b" rx="2"/><line x1="130" y1="156.0" x2="302" y2="156.0" stroke="#9ca3af" stroke-width="1" stroke-dasharray="3,3"/><text x="166.0" y="55.0" font-family="Inter, system-ui, sans-serif" font-size="11" font-weight="700" fill="#b45309" text-anchor="middle">−400</text><text x="166.0" y="318.0" font-family="Inter, system-ui, sans-serif" font-size="9.5" font-weight="400" fill="currentColor" text-anchor="middle">− Varekostnad</text><rect x="230.0" y="156.0" width="72.0" height="84.0" fill="#f59e0b" rx="2"/><line x1="230" y1="240.0" x2="402" y2="240.0" stroke="#9ca3af" stroke-width="1" stroke-dasharray="3,3"/><text x="266.0" y="151.0" font-family="Inter, system-ui, sans-serif" font-size="11" font-weight="700" fill="#b45309" text-anchor="middle">−350</text><text x="266.0" y="318.0" font-family="Inter, system-ui, sans-serif" font-size="9.5" font-weight="400" fill="currentColor" text-anchor="middle">− Driftskostn.</text><rect x="330.0" y="240.0" width="72.0" height="6.0" fill="#f59e0b" rx="2"/><line x1="330" y1="246.0" x2="502" y2="246.0" stroke="#9ca3af" stroke-width="1" stroke-dasharray="3,3"/><text x="366.0" y="235.0" font-family="Inter, system-ui, sans-serif" font-size="11" font-weight="700" fill="#b45309" text-anchor="middle">−25</text><text x="366.0" y="318.0" font-family="Inter, system-ui, sans-serif" font-size="9.5" font-weight="400" fill="currentColor" text-anchor="middle">− Finans (netto)</text><rect x="430.0" y="246.0" width="72.0" height="12.0" fill="#f59e0b" rx="2"/><line x1="430" y1="258.0" x2="602" y2="258.0" stroke="#9ca3af" stroke-width="1" stroke-dasharray="3,3"/><text x="466.0" y="241.0" font-family="Inter, system-ui, sans-serif" font-size="11" font-weight="700" fill="#b45309" text-anchor="middle">−50</text><text x="466.0" y="318.0" font-family="Inter, system-ui, sans-serif" font-size="9.5" font-weight="400" fill="currentColor" text-anchor="middle">− Skatt</text><rect x="530.0" y="258.0" width="72.0" height="42.0" fill="#10b981" rx="2"/><text x="566.0" y="253.0" font-family="Inter, system-ui, sans-serif" font-size="11" font-weight="700" fill="#046530" text-anchor="middle">175</text><text x="566.0" y="318.0" font-family="Inter, system-ui, sans-serif" font-size="9.5" font-weight="400" fill="currentColor" text-anchor="middle">= Årsresultat</text></svg>`,
          caption: 'Hver oransje søyle trekker fra en kostnad fra driftsinntektene på 1000. Det som står igjen på bunnlinjen – årsresultatet – er bare 175, altså 17,5 % av inntektene.'
        },
        {
          id: '2-2-heading-2',
          type: 'heading',
    ...
    // SEKSJON 2.3: Balansen
    {
      ...
      content: [
        ...
        {
          id: '2-3-diagram-balanse',
          type: 'diagram',
          order: 4.5,
          title: 'Balansen som to like høye blokker',
          svg: `<svg viewBox="0 0 620 360" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Balanse som to like høye blokker"><text x="190.0" y="45.0" font-family="Inter, system-ui, sans-serif" font-size="13" font-weight="700" fill="#046530" text-anchor="middle">EIENDELER</text><text x="450.0" y="45.0" font-family="Inter, system-ui, sans-serif" font-size="13" font-weight="700" fill="#046530" text-anchor="middle">EGENKAPITAL + GJELD</text><rect x="110.0" y="60.0" width="160.0" height="132.1" fill="#046530" rx="2"/><text x="190.0" y="124.1" font-family="Inter, system-ui, sans-serif" font-size="12" font-weight="600" fill="#fff" text-anchor="middle">Anleggsmidler</text><text x="190.0" y="141.1" font-family="Inter, system-ui, sans-serif" font-size="11" font-weight="400" fill="#fff" text-anchor="middle">370 MNOK</text><rect x="110.0" y="192.1" width="160.0" height="117.9" fill="#10b981" rx="2"/><text x="190.0" y="249.1" font-family="Inter, system-ui, sans-serif" font-size="12" font-weight="600" fill="#fff" text-anchor="middle">Omløpsmidler</text><text x="190.0" y="266.1" font-family="Inter, system-ui, sans-serif" font-size="11" font-weight="400" fill="#fff" text-anchor="middle">330 MNOK</text><rect x="370.0" y="60.0" width="160.0" height="125.0" fill="#0d9488" rx="2"/><text x="450.0" y="120.5" font-family="Inter, system-ui, sans-serif" font-size="12" font-weight="600" fill="#fff" text-anchor="middle">Egenkapital</text><text x="450.0" y="137.5" font-family="Inter, system-ui, sans-serif" font-size="11" font-weight="400" fill="#fff" text-anchor="middle">350 MNOK</text><rect x="370.0" y="185.0" width="160.0" height="89.3" fill="#f59e0b" rx="2"/><text x="450.0" y="227.6" font-family="Inter, system-ui, sans-serif" font-size="12" font-weight="600" fill="#fff" text-anchor="middle">Langsiktig gjeld</text><text x="450.0" y="244.6" font-family="Inter, system-ui, sans-serif" font-size="11" font-weight="400" fill="#fff" text-anchor="middle">250 MNOK</text><rect x="370.0" y="274.3" width="160.0" height="35.7" fill="#d97706" rx="2"/><text x="450.0" y="290.1" font-family="Inter, system-ui, sans-serif" font-size="10" font-weight="600" fill="#fff" text-anchor="middle">Kortsiktig gjeld</text><text x="450.0" y="305.1" font-family="Inter, system-ui, sans-serif" font-size="10" font-weight="400" fill="#fff" text-anchor="middle">100</text><text x="310.0" y="190.0" font-family="Inter, system-ui, sans-serif" font-size="34" font-weight="700" fill="#6b7280" text-anchor="middle">=</text><text x="190.0" y="336.0" font-family="Inter, system-ui, sans-serif" font-size="12" font-weight="700" fill="currentColor" text-anchor="middle">Sum: 700 MNOK</text><text x="450.0" y="336.0" font-family="Inter, system-ui, sans-serif" font-size="12" font-weight="700" fill="currentColor" text-anchor="middle">Sum: 700 MNOK</text></svg>`,
          caption: 'Venstre side (eiendeler) er alltid nøyaktig like høy som høyre side (egenkapital + gjeld) – derav navnet «balanse». Blokkhøydene viser proporsjonene: her er egenkapitalandelen 350/700 = 50 %.'
        },
        {
          id: '2-3-heading-2',
          type: 'heading',
    ...
    // SEKSJON 2.4: Kontantstrømoppstillingen
    {
      ...
      content: [
        ...
        {
          id: '2-4-diagram-kontantstrom',
          type: 'diagram',
          order: 6.5,
          title: 'Kontantstrømmen – hvor pengene kommer fra og går',
          svg: `<svg viewBox="0 0 560 340" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Kontantstrøm som waterfall"><line x1="20" y1="280" x2="550" y2="280" stroke="#d1d5db" stroke-width="1"/><rect x="30.0" y="201.4" width="72.0" height="78.6" fill="#3b82f6" rx="2"/><line x1="30" y1="201.4" x2="202" y2="201.4" stroke="#9ca3af" stroke-width="1" stroke-dasharray="3,3"/><text x="66.0" y="196.4" font-family="Inter, system-ui, sans-serif" font-size="11" font-weight="700" fill="#1e40af" text-anchor="middle">100</text><text x="66.0" y="298.0" font-family="Inter, system-ui, sans-serif" font-size="10" font-weight="400" fill="currentColor" text-anchor="middle">Start</text><rect x="130.0" y="60.0" width="72.0" height="141.4" fill="#10b981" rx="2"/><line x1="130" y1="60.0" x2="302" y2="60.0" stroke="#9ca3af" stroke-width="1" stroke-dasharray="3,3"/><text x="166.0" y="55.0" font-family="Inter, system-ui, sans-serif" font-size="11" font-weight="700" fill="#047857" text-anchor="middle">+180</text><text x="166.0" y="298.0" font-family="Inter, system-ui, sans-serif" font-size="10" font-weight="400" fill="currentColor" text-anchor="middle">+ Drift</text><rect x="230.0" y="60.0" width="72.0" height="70.7" fill="#ef4444" rx="2"/><line x1="230" y1="130.7" x2="402" y2="130.7" stroke="#9ca3af" stroke-width="1" stroke-dasharray="3,3"/><text x="266.0" y="55.0" font-family="Inter, system-ui, sans-serif" font-size="11" font-weight="700" fill="#b91c1c" text-anchor="middle">−90</text><text x="266.0" y="298.0" font-family="Inter, system-ui, sans-serif" font-size="10" font-weight="400" fill="currentColor" text-anchor="middle">− Investering</text><rect x="330.0" y="130.7" width="72.0" height="47.1" fill="#ef4444" rx="2"/><line x1="330" y1="177.9" x2="502" y2="177.9" stroke="#9ca3af" stroke-width="1" stroke-dasharray="3,3"/><text x="366.0" y="125.7" font-family="Inter, system-ui, sans-serif" font-size="11" font-weight="700" fill="#b91c1c" text-anchor="middle">−60</text><text x="366.0" y="298.0" font-family="Inter, system-ui, sans-serif" font-size="10" font-weight="400" fill="currentColor" text-anchor="middle">− Finansiering</text><rect x="430.0" y="177.9" width="72.0" height="102.1" fill="#3b82f6" rx="2"/><text x="466.0" y="172.9" font-family="Inter, system-ui, sans-serif" font-size="11" font-weight="700" fill="#1e40af" text-anchor="middle">130</text><text x="466.0" y="298.0" font-family="Inter, system-ui, sans-serif" font-size="10" font-weight="400" fill="currentColor" text-anchor="middle">= Slutt</text></svg>`,
          caption: 'Et sunt mønster: den grønne driftsstrømmen (+180) finansierer både investeringene (−90) og utbetalinger til eiere/långivere (−60), og kassa vokser likevel fra 100 til 130.'
        },
        {
          id: '2-4-heading-3',
          type: 'heading',
