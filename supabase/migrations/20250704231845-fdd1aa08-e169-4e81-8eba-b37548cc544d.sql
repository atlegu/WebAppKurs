-- Restore original 5.7 content with detailed market efficiency content
UPDATE sub_modules 
...
| Form | Informasjonssett som er «priset inn» | Praktisk implikasjon |
|------|-------------------------------------|---------------------|
| **Svak form** | Historiske priser og volumdata | Teknisk analyse og trend-strategier skal ikke gi systematisk meravkastning. |
| **Semisterk form** | All offentlig informasjon (regnskaper, nyheter, analytikerrapporter …) | Fundamental analyse basert på publiserte data skal ikke gi meravkastning over tid. |
| **Sterk form** | All informasjon – også innsideinformasjon | Selv investorer med privat informasjon kan ikke tjene ekstra (i praksis motbevist av insider-dommer). |
