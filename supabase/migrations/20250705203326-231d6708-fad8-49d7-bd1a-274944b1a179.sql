-- Fix the double asterisk formatting in 3.1 Introduksjon
UPDATE sub_modules 
...
Tidsverdien av penger er universalspråket i finans. Behersker du logikken bak renter, kan du analysere alt fra kredittkortvilkår til komplekse kontantstrømsprognoser.',
